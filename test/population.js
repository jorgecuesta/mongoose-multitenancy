...
describe('Multitenancy', function () {
    ...
    it('Should create different models for same tenant with Reference between models. A -> B -> C -> A', function (done) {
    ...
    it('Should create documents of each model without errors (no referenced)', function (finish) {
        var ATenant1 = mongoose.mtModel('tenant1.A'),
            BTenant1 = mongoose.mtModel('tenant1.B'),
            CTenant1 = mongoose.mtModel('tenant1.C');
        ...
        async.auto({
            ...
            async.auto({
                ...
                b_c: ['a_b', function (results, done) {
                    b.c.push(c._id);
                    b.save(done);
                }],
                c_a: ['b_c', function (results, done) {
                    c.a = a._id;
                    c.save(done);
                }]
